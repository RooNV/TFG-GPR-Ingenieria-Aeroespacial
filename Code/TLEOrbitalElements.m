function [OE] = TLE2OrbitalElements()
%% El objetivo de esta función: 
% Conseguir todos los parametros a partir de la información del TLE.

%% TLE
TLE = {'NOAA_17'; ...
    '1 27453U 02032A   02175.81115570 -.00000044  00000-0  00000+0 0    13'; ...
    '2 27453  98.7855 242.8893 0014889   5.7429 354.3975 14.21021993    06'};
...
% El char perteneciente a line1{8} es la clasificación del satélite
% U - unclassified
% C - classified
% S - secret
